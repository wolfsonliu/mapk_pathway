...
std::vector<std::string> reactantName(int functype)
{
	...
	name_vector.push_back("map3k");
	name_vector.push_back("map3kp");
	name_vector.push_back("map2k");
	name_vector.push_back("map2kp");
	name_vector.push_back("map3k_ras");
	name_vector.push_back("map3kp_m3kp");
	name_vector.push_back("map2k_map3kp");
	name_vector.push_back("map2kp_m2kp");
	name_vector.push_back("ras");
	name_vector.push_back("m3kp");
	name_vector.push_back("m2kp");
    } else if (functype == 4) {
	// 2s2p
	name_vector.push_back("map3k");
	name_vector.push_back("map3kp");
	name_vector.push_back("map2k");
	name_vector.push_back("map2kp");
	name_vector.push_back("map2k2p");
	name_vector.push_back("map3k_ras");
	name_vector.push_back("map3kp_m3kp");
	name_vector.push_back("map2k_map3kp");
	name_vector.push_back("map2kp_m2kp");
	name_vector.push_back("map2kp_map3kp");
	name_vector.push_back("map2k2p_m2kp");
	name_vector.push_back("ras");
	name_vector.push_back("m3kp");
	name_vector.push_back("m2kp");
    } else if (functype == 5) {
	...
	name_vector.push_back("map2k");
	name_vector.push_back("map2kp");
	name_vector.push_back("mapk");
	name_vector.push_back("mapkp");
	name_vector.push_back("map3k_ras");
	name_vector.push_back("map3kp_m3kp");
	name_vector.push_back("map2k_map3kp");
	name_vector.push_back("map2kp_m2kp");
	name_vector.push_back("mapk_map2kp");
	name_vector.push_back("mapkp_mkp");
	name_vector.push_back("ras");
	name_vector.push_back("m3kp");
	name_vector.push_back("m2kp");
	name_vector.push_back("mkp");
    } else if (functype == 6) {
	name_vector.push_back("map3k");
	name_vector.push_back("map3kp");
	name_vector.push_back("map2k");
	...
	name_vector.push_back("map2kp_map3kp");
	name_vector.push_back("map2k2p_m2kp");
	name_vector.push_back("mapk_map2k2p");
	name_vector.push_back("mapkp_mkp");
	name_vector.push_back("mapkp_map2k2p");
	name_vector.push_back("mapk2p_mkp");
	name_vector.push_back("ras");
	name_vector.push_back("m3kp");
	name_vector.push_back("m2kp");
	name_vector.push_back("mkp");
...
int ReactantConcentration::isStable()
{
    ...
    return ((sqrt(tmp / (big_num - 1)) / list[vct_length -1].reactant[final_out]) < threshold) ? 1 : 0;
}
...
int ReactantConcentration::odeFunction2s1p(double t, const double y[], double f[], void *para)
{
    static_cast<void>(t);    // convert type to avoid unused parameter warning
    Parameter params = *static_cast<Parameter *>(para);
    // use ras as the kinase for map3k, m3kp as the phosphatase for map3kp.
...
int ReactantConcentration::odeJacobian2s1p(double t, const double y[], double *dfdy, double dfdt[], void *para)
{
    static_cast<void>(t);    // convert type to avoid unused parameter warning
    // initiate.
    Parameter params = *static_cast<Parameter *>(para);
...
int ReactantConcentration::odeFunction2s2p(double t, const double y[], double f[], void *para)
{
    static_cast<void>(t);    // convert type to avoid unused parameter warning
    Parameter params = *static_cast<Parameter *>(para);
    // use ras as the kinase for map3k, m3kp as the phosphatase for map3kp.
...
//// Member-Function
//// odeJacobian2s2p:  needed by <gsl/gsl_odeiv2.h>, 2 stages, 2 phosphorylations.
int ReactantConcentration::odeJacobian2s2p(double t, const double y[], double *dfdy, double dfdt[], void *para)
{
    static_cast<void>(t);    // convert type to avoid unused parameter warning
    // initiate.
    Parameter params = *static_cast<Parameter *>(para);
...
int ReactantConcentration::odeFunction3s1p(double t, const double y[], double f[], void *para)
{
    static_cast<void>(t);    // convert type to avoid unused parameter warning
    Parameter params = *static_cast<Parameter *>(para);
    // use ras as the kinase for map3k, m3kp as the phosphatase for map3kp.
...
int ReactantConcentration::odeJacobian3s1p(double t, const double y[], double *dfdy, double dfdt[], void *para)
{
    static_cast<void>(t);    // convert type to avoid unused parameter warning
    // initiate.
    Parameter params = *static_cast<Parameter *>(para);
...
int ReactantConcentration::odeFunction3s2p(double t, const double y[], double f[], void *para)
{
    static_cast<void>(t);    // convert type to avoid unused parameter warning
    Parameter params = *static_cast<Parameter *>(para);
    // use ras as the kinase for map3k, m3kp as the phosphatase for map3kp.
...
int ReactantConcentration::odeJacobian3s2p(double t, const double y[], double *dfdy, double dfdt[], void *para)
{
    static_cast<void>(t);    // convert type to avoid unused parameter warning
    // initiate.
    Parameter params = *static_cast<Parameter *>(para);
    ...
    // map2k_map3kp.
    gsl_matrix_set(m, 10, 0, 0.0);
    gsl_matrix_set(m, 10, 1, params.f[2] * map2k + params.kb[2] * map2kp);
    ...
    gsl_matrix_set(m, 12, 1, params.f[4] * map2kp + params.kb[4] * map2k2p);
    gsl_matrix_set(m, 12, 2, 0.0);
